    ...
    >
      ...
      <Box component="form" onSubmit={handleSubmit} display="flex" flexDirection="column" gap={1.5}>
        ...
        <FormControl fullWidth size="small">
          ...
          >
            <MenuItem value="P1" sx={{ color: '#07F2E6', fontWeight: 700 }}>P1 - High</MenuItem>
            <MenuItem value="P2" sx={{ color: '#7A7A7A', fontWeight: 600 }}>P2 - Medium</MenuItem>
            <MenuItem value="P3" sx={{ color: '#7A7A7A', fontWeight: 500, opacity: 0.8 }}>P3 - Low</MenuItem>
          </Select>
        </FormControl>
